'''One final attempt with the 60x60 small roi. Checking with a different image processing method
that utilises otsu thresholding to see if squared mask is problem of image processing that involved
pusing intensity to 230. This uses otsu thresholding and then continues with the simmilar processing steps
as earlier'''

'''Result: Method failed still square masks are obtained demarcating different pixels'''
