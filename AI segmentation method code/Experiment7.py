...
'''Push intensity reduced to zero, entire image sent to SAM and all Images containing tumors selected from patient in BRATS dataset 2021.
Change in putting images to zero is made to see differnece if any on experiment. Lesser pixels will be pushed to 0 (mean-20 is used)'''

'''Results showed improvement in mask detection by SAM '''
...
''' Mean + Standard Deviation _/
    ...
    Results availiable: https://drive.google.com/uc?export=download&id=1MA9G1qO5jNqE0yUDZPuS8JZHQuSwYlql'''
