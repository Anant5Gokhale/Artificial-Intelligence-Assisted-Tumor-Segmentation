'''Code running with mps does not seem to crash. The following statement is not causing errors:
export PYTORCH_MPS_HIGH_WATERMARK_RATIO=0.0
'''

'''Push intensity is same 230, entire image sent to SAM and all Images dont contain tumors. Images are
random.'''

'''Result: Masks are not square anymore, but tumor not segmented'''
