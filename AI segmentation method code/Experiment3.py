'''To takle the previous problem of unwanted squared masks enclosing pixels. Gaussian blur of a large
kernel value (11,11) was tried as an extreme case. Hopefully SAM will see and demarcate the tumor instead
of the square pixels. '''

''' Result showed square masks again'''
