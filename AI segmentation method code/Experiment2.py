'''SAM was unable to segment tumor regions from Tumor ROIs. Reason being it was the size 60x60,
which appears as a pixelated or blows up, causing square masks detected demarcating different pixels.
Even a complete dark image had 9 square masks of equal size covering entire image'''
