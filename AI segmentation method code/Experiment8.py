'''Trying with push 0 and all pixels below mean will be made 0. (not mean-20)'''

'''Results better than mean-20 when same push intensity of 0 is used. Above 80% showed good whole tumor segmentation'''
...
''' Mean + Standard Deviation _/
    ...
    Results availiable: https://drive.google.com/uc?export=download&id=1E5eC12Hm7jkXnVpfb0LzNXm38PTA-X6p'''
